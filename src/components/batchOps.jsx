 ...
 */
export async function batchProcess(items, fn, onProgress = () => {}, cancelRef = null, concurrency = 8, batchDelay = 500) {
  let completed = 0;
 ...
 */
export async function batchDelete(ids, deleteFn, onProgress = () => {}, cancelRef = null, concurrency = 1, delay = 400) {
  await batchProcess(ids, id => deleteFn(id), onProgress, cancelRef, concurrency, delay);
}
...
export async function batchUpdate(items, updateFn, onProgress = () => {}, cancelRef = null) {
  await batchProcess(items, item => updateFn(item), onProgress, cancelRef, 8, 500);
}
